...
<head>
    <meta charset="utf-8" />
    <title>Sistem Pakar Buah Durian</title>
...
<!-- header end -->
    ...
    <nav class="navbar navbar-inverse">
        ...
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="#">SP Diagnosa Penyakit Tanaman Buah Durian</a>
        </div>
        ...
        <div class="collapse navbar-collapse" id="navbar-collapse-2">
          <ul class="nav navbar-nav navbar-right">
            ...
            <li><a href="?page=bantuan">Tata cara perawatan buah durian</a></li>
            <li>
              <a  a href="../skripsidurian/admin/index.php" class="btn btn-warning outline btn-circle collapsed">Login Admin</a>
            </li>
          </ul>
...
<div class="bawah"><div class="copy">
            <p> Sistem Pakar Diagnosa Penyakit Buah Durian </p>
        </div>
    </div>
<!-- footer end -->
